...
public class DomesticInternodalPassengerDemand extends InternodalPassengerDemand{
	 ...
	 */
	public DomesticInternodalPassengerDemand(String fileName) throws FileNotFoundException, IOException {

		super();
		
		LOGGER.info("Reading domestic internodal passenger air demand from file: {}", fileName);
