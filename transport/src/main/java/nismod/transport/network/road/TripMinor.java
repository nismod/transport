...
public class TripMinor extends Trip {
	...
	public String getOriginLAD() {
		...
		String originTemproZone = TripMinor.zoning.getZoneIDToCodeMap().get(this.origin);
	...
	public String getDestinationLAD() {
		...
		String destinationTemproZone = TripMinor.zoning.getZoneIDToCodeMap().get(this.destination);
	...
	public String getOriginTemproZone() {
		...
		String temproCode = TripMinor.zoning.getZoneIDToCodeMap().get(this.origin);
		return temproCode;
	}
	...
	public String getDestinationTemproZone() {
		...
		String temproCode = TripMinor.zoning.getZoneIDToCodeMap().get(this.destination);
		return temproCode;
	}
